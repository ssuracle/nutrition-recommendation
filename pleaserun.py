...
# 사용자 정보 입력
weight = st.number_input("체중 (kg):", min_value=0.0, step=0.1, value=0.0)  # 기본값을 0.0으로 설정
height = st.number_input("키 (cm):", min_value=0.0, step=0.1, value=0.0)  # 기본값을 0.0으로 설정
age = st.number_input("나이:", min_value=0, step=1, value=0)  # 기본값을 0으로 설정
gender = st.selectbox("성별:", options=["선택하세요", "남성", "여성"], index=0)  # 기본값을 "선택하세요"로 설정
activity_level = st.selectbox("활동 수준:", options=["선택하세요", "낮음", "보통", "높음"], index=0)  # 기본값을 "선택하세요"로 설정
